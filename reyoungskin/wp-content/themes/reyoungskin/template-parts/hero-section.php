...
<section class="w-full">
  <div class="flex flex-col lg:flex-row min-h-[600px] md:min-h-[700px] lg:min-h-[800px] mx-auto max-w-screen-2xl">
    <div class="w-full lg:w-1/2 min-h-[400px] lg:min-h-full bg-cover bg-center bg-no-repeat"
    ...
    <div
      ...
      <div class="w-full max-w-xl text-center">
        ...
        <!-- Logo -->
        <div class="mb-8 md:mb-10 lg:mb-12 flex justify-center">
          <img src="<?php echo esc_url($hero_logo); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?> Logo"
            class="w-32 h-32 md:w-40 md:h-40 lg:w-44 lg:h-44 object-contain">
        </div>

        <!-- Headline -->
        <h1 class="mb-6 md:mb-8 text-4xl md:text-5xl lg:text-6xl tracking-wider !font-thin font-serif"
        ...
        <!-- Subheadline -->
        <p class="mb-8 md:mb-10 lg:mb-12 text-base md:text-lg lg:text-2xl leading-relaxed" style="color: #5F8F8B;">
        ...
        <a href="https://www.fresha.com/a/beauty-bar-n-makeup-lash-n-brows-auckland-437-remuera-road-al4mar88/booking?menu=true&offerItems=sv%3A25356601&pId=758924&dppub=true&utm_content=link_in_bio&utm_medium=social&utm_source=ig&employeeId=2577179&cartId=4fa72077-b048-4326-8ab5-55611323aa81"
          ...
          class="inline-block px-12 md:px-16 lg:px-20 !no-underline py-4 md:py-5 font-serif text-2xl md:text-3xl lg:text-4xl font-normal text-white rounded-full transition-all duration-300 mb-8 md:mb-10 lg:mb-12 hover:brightness-110"
        ...
        <div class="flex flex-col items-center gap-2">
          <a href="tel:0212315978" class="flex items-center gap-3 transition-colors duration-300 hover:opacity-80"
            ...
            <span class="text-xl md:text-2xl font-medium">021 231 5978</span>
          </a>
          <span class="text-sm md:text-base" style="color: #5F8F8B;">Call for faster service</span>
        </div>
