  ...
  <div class="max-w-screen-2xl mx-auto px-6 md:px-8 lg:px-12">
    ...
    <div class="space-y-12 md:space-y-16 lg:space-y-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
        ...
        <!-- Service Card 1 -->
        <div class="group">
          <div class="relative overflow-hidden rounded-lg shadow-md transition-transform duration-300 hover:scale-105">
            <div
      ...
      <div class="flex justify-center">
        <a href="<?php echo esc_url(home_url('/pricing#group-1')); ?>"
          class="inline-block px-12 md:px-16 py-3 md:py-4 text-base md:text-lg font-semibold text-white rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
      ...
      <div class="flex justify-center">
        <a href="<?php echo esc_url(home_url('/pricing#group-2')); ?>"
          class="inline-block px-12 md:px-16 py-3 md:py-4 text-base md:text-lg font-semibold text-white rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
          style="background: linear-gradient(135deg, #58A19E 0%, #82BF9D 50%, #BAD4C0 100%);"
      ...
      <div class="flex justify-center">
        <a href="<?php echo esc_url(home_url('/pricing#group-3')); ?>"
          class="inline-block px-12 md:px-16 py-3 md:py-4 text-base md:text-lg font-semibold text-white rounded-full transition-all duration-300 hover:shadow-lg hover:scale-105"
          style="background: linear-gradient(135deg, #58A19E 0%, #82BF9D 50%, #BAD4C0 100%);"
